        ...
        <nav className="border-b border-slate-100 sticky top-0 bg-white z-50 shadow-sm">
          ...
          <div className="max-w-7xl mx-auto px-4 md:px-6">
            <div className="h-20 md:h-24 flex items-center justify-between gap-4">
              ...
              {/* LOGO AREA */}
              <Link href="/" className="relative flex items-center h-full w-[130px] md:w-[350px] shrink-0 overflow-hidden">
              ...
              {/* DESKTOP NAV LINKS (Visible only on Laptop) */}
              ...
              {/* MOBILE CONTACT BUTTON (Standalone on right for mobile) */}
              <div className="lg:hidden">
                <Link
                  href="/contact-us"
                  className="bg-blue-900 text-white px-4 py-2 rounded-sm text-[10px] font-bold uppercase tracking-wider shrink-0"
                >
                  Contact
                </Link>
              </div>
            ...
            {/* SECONDARY MOBILE NAV (All options visible at once below the logo) */}
            <div className="lg:hidden grid grid-cols-4 border-t border-slate-50 py-3 gap-1 text-center">
              <Link href="/about-us" className="text-[9px] font-bold uppercase tracking-tighter text-slate-500 py-1">About</Link>
              <Link href="/what-we-do" className="text-[9px] font-bold uppercase tracking-tighter text-slate-500 py-1">What We Do</Link>
              <Link href="/who-we-are" className="text-[9px] font-bold uppercase tracking-tighter text-slate-500 py-1">Who We Are</Link>
              <Link href="/work" className="text-[9px] font-bold uppercase tracking-tighter text-slate-500 py-1">Work</Link>
            </div>
          </div>
        </nav>
        ...
        <footer className="bg-slate-50 border-t border-slate-200 py-12 md:py-16">
          <div className="max-w-7xl mx-auto px-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-12">
              ...
              <div>
                <h4 className="font-bold text-slate-900 text-xs mb-6 tracking-widest uppercase">Connect</h4>
                <address className="not-italic text-sm text-slate-500 space-y-4">
                  <div>
                    <p className="font-bold text-slate-700 text-[10px] tracking-wider mb-1 uppercase">Registered Office</p>
                    <p>102, 11/160A, VKV Lane, Chembumukku,</p>
                    <p>Vazhakkala, Kakkanad, Ernakulam,</p>
                    <p>Kerala, India 682030</p>
                  </div>
                  <div>
                    <p className="font-bold text-slate-700 text-[10px] tracking-wider mb-1 uppercase">Email</p>
              ...
              <div>
                <h4 className="font-bold text-slate-900 text-xs mb-6 tracking-widest uppercase">Identification</h4>
            ...
            <div className="mt-12 md:mt-16 pt-8 border-t border-slate-200 text-center text-[10px] text-slate-400 tracking-[0.3em] uppercase">
