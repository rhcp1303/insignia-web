...
export default function Home() {
  ...
  return (
    <main className="min-h-screen md:h-[calc(100vh-6rem)] overflow-y-auto md:snap-y md:snap-mandatory scroll-smooth bg-white selection:bg-blue-100">
      ...
      <section className="min-h-screen md:h-full md:max-h-full md:snap-start flex flex-col justify-center bg-[#FDFDFD] border-b border-slate-200 py-16 md:py-0">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {verticals.map((v, i) => (
              <Link
                href={v.link}
                key={i}
                className="relative h-[40vh] md:h-[45vh] group overflow-hidden rounded-xl border border-slate-200 block bg-slate-900 shadow-sm"
              >
                <img
                  src={v.img}
                  alt={v.title}
                ...
                <div className="relative z-20 p-8 h-full flex flex-col justify-end">
                  <h3 className="text-lg font-bold text-white mb-3 tracking-tight group-hover:text-blue-400">
                    {v.title}
                  </h3>
                  <p className="text-slate-300 text-[13px] leading-relaxed mb-6 opacity-90">
                    {v.desc}
                  </p>
      ...
      {/* SECTION 2: CTA */}
      <section className="min-h-screen md:h-full md:max-h-full md:snap-start relative flex flex-col justify-center bg-[#020617] py-20 md:py-0">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          ...
          <Link
            href="/work"
            className="inline-block bg-white text-slate-950 px-10 md:px-14 py-4 md:py-5 font-black uppercase tracking-widest text-[10px] md:text-xs hover:bg-blue-600 hover:text-white transition-all shadow-xl"
          >
